http://localhost:3000/api-docs/#/Authentication/post_users_login
...
docker-compose up --build
 ...
 lsof -i :5432 || ss -tulnp | grep 5432
 ➜  Traveler_Bloggers_Platform git:(develop) ✗ lsof -i :5432 || ss -tulnp | grep 5432
